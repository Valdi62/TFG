...
class MRConvolutionalModelHistogram(nn.Module):
    def __init__(self,base_model,num_bins=32,dropout=0.2,size1=512,size2=1024,size3=256):
        super().__init__()
        self.base_model = base_model
        ...
        # El modelo es igual al anterior pero utiliza una capa de histograma adicional después de la cabeza del modelo base
        self.histogram = HardHistogram(size1,self.num_bins)
